...
def Euler_Maruyama_Generator(x_0,
    ...
    X_T_Empirical = np.zeros([N_Euler_Maruyama_Steps,N_Monte_Carlo_Samples,problem_dim])
...
#         if Hurst == 0.5:
        ...
        for t in range(N_Euler_Maruyama_Steps):
            ...
            W_t = np.random.normal(0,np.ones(problem_dim))*sqrt_dt
