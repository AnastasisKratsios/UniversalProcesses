...
MCOracle_Facts = np.array([0,(N_Monte_Carlo_Samples*(X_train.shape[0]+X_test.shape[0])),Test_Set_PredictionTime_MC,1])
Deep_Neural_Model_Facts = np.array([N_params_deep_classifier,(N_params_deep_classifier+N_Monte_Carlo_Samples*(X_train.shape[0]+X_test.shape[0])),Time_Lapse_Model_A,(timer_output/Test_Set_PredictionTime_MC)])
